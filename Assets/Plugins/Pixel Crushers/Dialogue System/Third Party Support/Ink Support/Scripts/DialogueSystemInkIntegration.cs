...
namespace PixelCrushers.DialogueSystem.InkSupport
{
    ...
    public class DialogueSystemInkIntegration : MonoBehaviour
    {
        ...
        [Tooltip("Deprecated. Use InkSaver component instead.")]
        public bool includeInSaveData = false;
        ...
        protected virtual void CreateDatabase()
        {
            ...
            // Turn off 'Always Force Response Menu':
            var originalSettings = DialogueManager.displaySettings.inputSettings;
            inkConversation.overrideSettings.useOverrides = true;
            inkConversation.overrideSettings.overrideInputSettings = true;
            inkConversation.overrideSettings.alwaysForceResponseMenu = false;
            inkConversation.overrideSettings.includeInvalidEntries = false;
            inkConversation.overrideSettings.responseTimeout = originalSettings.responseTimeout;
            inkConversation.overrideSettings.cancelSubtitle = new InputTrigger(originalSettings.cancel.key, originalSettings.cancel.buttonName);
            inkConversation.overrideSettings.cancelConversation = new InputTrigger(originalSettings.cancelConversation.key, originalSettings.cancel.buttonName);
        ...
        protected virtual void ProcessTags(DialogueEntry entry)
        {
        ...
        protected virtual void AddResponses(DialogueEntry entry)
        {
            entry.outgoingLinks.Clear();
        ...
        {
            if (activeStory == null || subtitle == null || subtitle.dialogueEntry.conversationID != InkConversationID)
            {
